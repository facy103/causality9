  ...
  },
{
...
}, 
 {
  ...
  {
    "title": "{רצון2}",
    "question": "אם הינך רוצה {רצון1} {הכנהלרצון2} אז מה הינך בעצם רוצה?",
    "dialogeType": "horizontal",
    "placeholder": "סיבת הרצון",
  ...
  },
  {
    ...
    "question": "חקירת סיבתיות__האם ועד כמה מחויב ש{רצון1},__יגרום לתוצאה של {רצון2}?",
    "dialogeType": "prompt",
    "buttons": { "a": "לא מחויב", "b": "מחויב" },
    "answer": "",
    "ref": ["{רצון2}","{רצון1}"],
    "css": [{"color": [ {"חקירת סיבתיות":"#8c94a8"},{"{רצון2}":"#ffba01"},{"{רצון1}":"#ffba01"}]},
