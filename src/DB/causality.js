const questions = [
  ...
  },
  {
    ...
    "question": "האם הסיבה מחויבת?__האם ודאי ב 100% {סיבה}?",
    "dialogeType": "prompt",
    "answer": "",
    "buttons": { "a": "לא ב 100%", "b": "ב 100%" },
    "ref": ["{סיבה}"],
  ...
  },
  {
    ...
    "question": "האם הסיבה מחויבת?__האם מחויב ש{תוצאה} {סיבה}?__האם יש אפשרות ש{תוצאה} בגלל סיבות אחרות או נוספות?",
    "dialogeType": "prompt",
    "answer": "",
  ...
  {
    "title": "{האםהסיבהמחייבת}",
    "question": "האם יש אפשרות ש{תוצאה} כי {סיבההופכית}?",
    "dialogeType": "prompt",
    "answer": "",
    "buttons": { "a": "אין אפשרות", "b": "יש אפשרות" },
    "ref": ["{תוצאה}","{סיבה}","{סיבה}","{סיבההופכית}"],
    "css":
  ...
  {
    "title": "{האםהסיבהמחייבת}",
    "question": "האם יש אפשרות ש{סיבה} יגרום ל{תוצאההופכית}?",
    "dialogeType": "prompt",
    "answer": "",
    "buttons": { "a": "אין אפשרות", "b": "יש אפשרות" },
    "ref": ["{סיבה}","{תוצאההופכית}"],
    "css":
            [{"color": [{"{תוצאההופכית}":"#ffba01"},{"{סיבה}":"#ffba01"}]},
            ],
            "blockDesign": true
  },
  {
